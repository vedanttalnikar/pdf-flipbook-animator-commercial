...
class Flipbook {
    ...
    showSpread(pageNum) {
        // In spread mode, show two pages side-by-side with fade transition
        if (this.isAnimating) return;
        ...
        const duration = 400; // Smooth but quick fade
