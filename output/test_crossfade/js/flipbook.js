...
class Flipbook {
    ...
    showSpread(pageNum) {
        // In spread mode, show two pages side-by-side with cross-fade (no flash)
        if (this.isAnimating) return;
        ...
        // If same spread, just show without animation
        if (leftPageNum === oldLeftPageNum) {
        ...
        // Prepare new pages (invisible, positioned absolutely on top)
        ...
        if (newLeftPage) {
            ...
            newLeftPage.style.width = '50%';
            newLeftPage.style.zIndex = '2';
        }
        ...
        if (newRightPage) {
            ...
            newRightPage.style.width = '50%';
            newRightPage.style.zIndex = '2';
        }
        
        // Trigger reflow
        if (newLeftPage) newLeftPage.offsetHeight;
        
        // Cross-fade: old pages fade out while new pages fade in simultaneously
        ...
        setTimeout(() => {
            ...
            if (newLeftPage) {
                ...
                newLeftPage.style.position = 'relative';
